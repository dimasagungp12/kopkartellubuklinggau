...
<head>
    ...
    <title>Update Data Pendapatan </title>
</head>
...
<body>  
    ...
    <a href="index.php" class="btn btn-primary"><i class='fa fa-arrow-left'></i> Kembali</a>
        ...
        <select name="uraian" id="uraian" class="from-select" required>
            <option value="Pengadaan Telkom" <?php if($data['uraian'] == 'Pengadaan Telkom') echo 'selected'; ?>>Pengadaan Telkom</option>
            <option value="Pengadaan Finnet" <?php if($data['uraian'] == 'Pengadaan Finnet') echo 'selected'; ?>>Pengadaan Finnet</option>
            <option value="Simpan Pinjam" <?php if($data['uraian'] == 'Simpan Pinjam') echo 'selected'; ?>>Simpan Pinjam</option>
            <option value="Lain-lain" <?php if($data['uraian'] == 'Lain-lain') echo 'selected'; ?>>Lain-lain</option>
        </select>
        <br>
        <br>
