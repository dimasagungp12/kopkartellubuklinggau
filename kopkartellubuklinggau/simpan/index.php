...
<div class="container mt-3">
  ...
  <table class="table table-striped table-hover table-bordered">
    ...
    while($data = mysqli_fetch_array($query)) {
        ...
        $jumlah = $pokok + $sukarela + $wajib;
        echo "<tr>"; 
        echo "<td>" . $data['id'] . "</td>";
        echo "<td>" . $data['nama'] . "</td>";
        echo "<td>" . $data['loker'] . "</td>";
        echo "<td>Rp. " . number_format($pokok, 0, ".", ".") . "</td>";
        echo "<td>Rp. " . number_format($sukarela, 0, ".", ".") . "</td>";
        echo "<td>Rp. " . number_format($wajib, 0, ".", ".") . "</td>";
        echo "<td>Rp. " . number_format($jumlah, 0, ".", ".") . "</td>";
        echo "<td>Rp. " . number_format($kontribusi, 0, ".", ".") . "</td>";
        echo "<td>
                <div class='row'>
...
<table>
    <tr>
        <td colspan="0"></td>
        <td style="text-align:center;font-weight:bold;color:black;">Total Jumlah :</td>
        <td style="text-align:right;font-weight:bold;color:black;"><?php echo "Rp. " . number_format($total, 0, ".", "."); ?></td>
    </tr> 
</table>
