...
<head>
    ...
    <title>Sign in to Koperasi Telkom</title>
</head>
<body class="h-100 d-flex align-items-center py-2">
    <div class="form-sign w-100 m-auto p-4 text-center">
        <form action="" method="post" autocomplete="off">
            ...
            <h1 class="my-3 fs-3">Sign in <span></span></h1>
            <?php if (isset($error)): ?>
            ...
            <div class="mt-5 text-muted">
                ...
                <a href="https://www.google.com/maps/place/PT.+TELKOM+Lubuklinggau/@-3.2958425,102.8596516,17z/data=!3m1!4b1!4m6!3m5!1s0x2e30e0fd0ce6cb11:0xe5055abf540d821f!8m2!3d-3.2958479!4d102.8618403!16s%2Fg%2F11cjh_4h81" target="_blank" rel="noopener noreferrer" class="link-warning text-decoration-none fw-bold">
                    <i class="bi bi-balloon-heart-fill text-warning" aria-hidden="true"></i> Kopkartel Lubuklinggau
                </a>
            </div>
        </form>
    </div>
