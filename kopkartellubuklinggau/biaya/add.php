...
<body>
    ...
    <a href="index.php" class="btn btn-primary"><i class='fa fa-arrow-left'></i> Kembali</a>
        <form action="" method="post">
            <?php
                $sqlGetLastId = "SELECT id FROM biayamasuk ORDER BY id DESC LIMIT 1";
    ...
    <select class="form-select" name="uraian" required>
        ...
        <option value="Ops Barang & Jasa Telkom">Ops Barang & Jasa Telkom</option>
        <option value="Gaji Karyawan">Gaji Karyawan</option>
        <option value="Bingkisan Lebaran">Bingkisan Lebaran</option>
        <option value="Biaya Penyusutan">Biaya Penyusutan</option>
        <option value="Biaya ATK & Operasional">Biaya ATK & Operasional</option>
        <option value="Biaya Rekening">Biaya Rekening</option>
...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sqlAdd = "INSERT INTO biayamasuk (id, tanggal, uraian, jumlah) VALUES ('$id', '$tanggal', '$uraian', '$jumlah')";
