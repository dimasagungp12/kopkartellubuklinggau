        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 mt-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="../biaya/index.php" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Buku Kas    
                    </a>
                ...
                <a href="../logout.php" class="btn btn-warning mb-2 fw-semibold d-lg-none">Logout</a>
            </div>
        </div>
    </nav>
